...
factFindApp.controller('employmentCtrl', ['$scope', '$rootScope', 'selectBoxService', 'employmentService', 'localStorageService', '$firebaseObject', 'firebaseService', 'toaster', '$filter',
    function ($scope, $rootScope, selectBoxService, employmentService, localStorageService, $firebaseObject, firebaseService, toaster, $filter) {
        ...
        $scope.checkPartnerTyping = function (field) {
            var flg = false;
            if ($scope.typing.client && $scope.typing.client['employmentForm']
                    && $scope.typing.client['employmentForm']['field'] == field
                    && $scope.typing.client['employmentForm']['status']) {
                flg = true;
            }
            return flg;
        };
...
//                $rootScope.tickTab('employmentandincome');
//            } else {
//                $rootScope.removeTickTab('employmentandincome');
//            }
        };
