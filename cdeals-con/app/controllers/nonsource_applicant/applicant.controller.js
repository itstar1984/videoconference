'use strict';
factFindApp.controller('nonsouceApplicantCtrl', ['$scope', '$rootScope', 'applicantService', 'extraLenderService', 'addresstService', 'localStorageService', 'quoteService', '$firebaseObject', 'firebaseService', 'selectBoxService', 'toaster', '$filter',
    function ($scope, $rootScope, applicantService, extraLenderService, addresstService, localStorageService, quoteService, $firebaseObject, firebaseService, selectBoxService, toaster, $filter) {
        ...
        $scope.checkPartnerTyping = function (field) {
            var flg = false;
            if ($scope.typing.client && $scope.typing.client['nonsourceApplicantForm']
                    && $scope.typing.client['nonsourceApplicantForm']['field'] == field
                    && $scope.typing.client['nonsourceApplicantForm']['status']) {
                flg = true;
            }
            return flg;
        };
