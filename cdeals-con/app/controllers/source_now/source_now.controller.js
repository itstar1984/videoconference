...
factFindApp.controller('sourceNowCtrl', ['$scope', '$rootScope', '$state', 'sourceService', 'localStorageService', '$firebaseObject',
    ...
    function ($scope, $rootScope, $state, sourceService, localStorageService, $firebaseObject, firebaseService, toaster) {
        ...
        $scope.changeFilter = function () {
            ...
            //            if (!angular.isDefined($scope.customer.intialSourceFilter.lender)) {
        ...
        $scope.disableTerm = function (value) {
            //            if ($scope.customer.intialSourceFilter && $scope.customer.intialSourceFilter.Term && !_.contains($scope.customer.intialSourceFilter.Term, value) && $scope.customer.intialSourceFilter.Term.length > 1) {
            //                return true;
            //            } else {
            return false;
            //            }
        ...
        $scope.disableProductType = function (value) {
            //            if ($scope.customer.intialSourceFilter && $scope.customer.intialSourceFilter.ProductType && !_.contains($scope.customer.intialSourceFilter.ProductType, value) && $scope.customer.intialSourceFilter.ProductType.length > 1) {
            //                return true;
            //            } else {
            return false;
            //            }
