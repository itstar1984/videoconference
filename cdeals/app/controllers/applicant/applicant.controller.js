...
factFindApp.controller('applicantCtrl', ['$scope', '$rootScope', 'selectBoxService', 'applicantService', 'localStorageService', 'extraLenderService', 'addresstService', '$firebaseObject', 'firebaseService', 'toaster', '$filter',
    function ($scope, $rootScope, selectBoxService, applicantService, localStorageService, extraLenderService, addresstService, $firebaseObject, firebaseService, toaster, $filter) {
        ...
        $scope.checkPartnerTyping = function (field) {
            var flg = false;
            if ($scope.typing.consultant && $scope.typing.consultant['applicantForm']
                    && $scope.typing.consultant['applicantForm']['field'] == field
                    && $scope.typing.consultant['applicantForm']['status']) {
                flg = true;
            }
            return flg;
        };
        ...
        var initialize = function () {
            ...
            object.$loaded().then(function (data) {
                ...
                angular.forEach($scope.applicants, function (applicant) {
                    if (angular.isUndefined($scope.customer.applicants[applicant.id])) {
                        $scope.customer.applicants[applicant.id] = {
                            ...
                            Employment: {CurrentEmployment: true},
                ...
                if (angular.isUndefined($scope.customer.ExtraCommonLenderQn)) {
                    $scope.customer.ExtraCommonLenderQn = {IsBridging: false, IsHelptoBuy: false, IsLimitedBTL: false, IsMortgagePortable: false,
                        IsBridgingMainResidence: false, RolledUpInterest: false, IsHMO: false, IsFamilyLet: false, IsStudentLet: false, Payday12Months: false,
                        PaydayRepaid: false, 'IPA': false, ParkingStatus: false, IsParking: false, IsGarage: 'No'};
                }
                ...
                if (angular.isUndefined($scope.customer.Properties)) {
                    $scope.customer.Properties = {Lift: false, Converted: false, PurposeBuilt: false, StudioFlat: false, BalconyAccess: false,
                        ExLocalAuthority: false, AgriculturalTie: false, ArchitectCertificate: false, SelfBuild: false, IsNewBuild: false, SemiCommercial: false, IsUsedForBuisnessPurpose: false, IsOwnershipShared: false};
                }
                ...
                if (response.length) {
                    ...
                    extraLenderService.getDetails({FFID: localStorageService.get('FFID')}).then(function (response) {
                        if (response.ExtraQnID) {
                            ...
                            $scope.customer.ExtraCommonLenderQn.App1OtherNationality = (extraCommonDetails.App1OtherNationality !== "") ? extraCommonDetails.App1OtherNationality : null;
                            $scope.customer.ExtraCommonLenderQn.App2OtherNationality = (extraCommonDetails.App2OtherNationality !== "") ? extraCommonDetails.App2OtherNationality : null;
                            $scope.customer.ExtraCommonLenderQn.App3OtherNationality = (extraCommonDetails.App3OtherNationality !== "") ? extraCommonDetails.App3OtherNationality : null;
                            $scope.customer.ExtraCommonLenderQn.App4OtherNationality = (extraCommonDetails.App4OtherNationality !== "") ? extraCommonDetails.App4OtherNationality : null;
