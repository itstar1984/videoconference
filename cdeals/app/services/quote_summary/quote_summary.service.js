...
factFindApp.service('quoteService', ['$resource', '$q', 'apiBaseUrl', function ($resource, $q, apiBaseUrl) {
        ...
        return{
            getActiveQuotes: function (details) {
                var deferred = $q.defer();
                api.get({action: 'Get', subaction: 'GetActiveMort', request: 'GET', FFID: details.FFID}, function (response) {
            ...
            getDeActiveQuotes: function (details) {
                var deferred = $q.defer();
                api.get({action: 'Get', subaction: 'GetDeActiveMort', request: 'GET', FFID: details.FFID}, function (response) {
                    deferred.resolve(response);
                }, function (error) {
                    deferred.reject(error);
                });
