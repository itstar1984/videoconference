...
//    
//    $('.benifits_title').click(function () {
//        console.log("enter");
//       $(this).find('.panel-body').toggle(); 
//    });

//    $(".panel-with-data .panel-title a").click(function (event) {
...
function togglepanel(element) {
    $(element).parents(".panel-with-data").find(".panel-body").slideToggle(100);
}
function toggleChatPanel(element) {
    var visiblity = $('#chat-panel-body').is(":visible");
    $(element).parents(".chat-panel").find(".panel-body").slideToggle(100);
    if (!visiblity) {
        $('.chat-box').css({
            'top': 'calc(100% - 386px)'
        });
